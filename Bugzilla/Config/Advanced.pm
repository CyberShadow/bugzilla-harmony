...
use constant get_param_list => (
  ...
  {name => 'sentry_uri', type => 't', default => '',},

  {name => 'metrics_enabled', type => 'b', default => 0},
  {
  ...
  {name => 'metrics_elasticsearch_index', type => 't', default => 'bmo-metrics'},
  {name => 'metrics_elasticsearch_type',  type => 't', default => 'timings'},
  {
